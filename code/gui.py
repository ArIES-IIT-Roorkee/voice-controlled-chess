...
def print_board(board, color=chess.WHITE):
    ...
    print_empty_board()
    SCREEN.blit(pygame.transform.scale(ONE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(0.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(TWO, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(1.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(THREE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE,int(2.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FOUR, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(3.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FIVE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(4.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SIX, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(5.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SEVEN, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE,int(6.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(EIGHT, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( 8*SQUARE_SIDE, int(7.25* SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(ONE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(0.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(TWO, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(1.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(THREE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect((int(2.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FOUR, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(3.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FIVE, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(4.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SIX, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(5.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SEVEN, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect((int(6.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(EIGHT, (SQUARE_SIDE1, SQUARE_SIDE1)),pygame.Rect(( int(7.25*SQUARE_SIDE), 8* SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
